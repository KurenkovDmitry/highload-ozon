...
Пусть и слабо пока развитый, но так как есть домен для США, то имеет смысл расположить ЦОДы и в Вашингтоне (под развитие), но тут будет зависеть от популярности сайта (открытых данных нет)
