...
| Nginx               | 60             | 16 ядер, 32 ГБ RAM               | Hetzner       |
| Redis (фронтенд)    | 30             | 16 ядер, 64 ГБ RAM, 1TB SSD      | AWS           |
| PostgreSQL          | 65             | 32 ядра, 128 ГБ RAM, 2TB SSD     | AWS           |
| ClickHouse          | 24             | 16 ядер, 64 ГБ RAM, 2TB SSD      | AWS           |
| Redis (бэкенд)      | 30             | 16 ядер, 64 ГБ RAM, 1TB SSD      | AWS           |
| Elasticsearch       | 18             | 16 ядер, 64 ГБ RAM, 2TB SSD      | AWS           |
| Amazon S3 (шлюзы)   | 18             | 16 ядер, 64 ГБ RAM, 2TB SSD      | AWS           |
| Kafka               | 42             | 32 ядра, 128 ГБ RAM, 2TB SSD     | Hetzner       |
| Splunk              | 18             | 16 ядер, 64 ГБ RAM, 2TB SSD      | AWS           |
| InfluxDB            | 18             | 16 ядер, 64 ГБ RAM, 1TB SSD      | AWS           |
| Grafana             | 12             | 8 ядер, 16 ГБ RAM, 500GB SSD     | AWS           |
| Prometheus          | 30             | 16 ядер, 64 ГБ RAM, 1TB SSD      | AWS           |
