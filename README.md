...
Начнем с пользователей, которых 58,18 млн., тогда объем для их хранения примерно 18 / 1024 / 1024 * 58,18 * 10^(6) ≈ 998,7 гигабайт
...
Начнем с покупателей, которых 575 тыс., тогда объем для их хранения примерно 0,00002530 * 575 * 10^(3) ≈ 14,55 гигабайт
...
Тогда для прогрузки 9 отзывов нужно 0,00000108 Гб, тогда необходимо 230,67 Гбайт/сутки
...
| Прогрузка отзывов (по 9)                           | 0,00267         | 0,00801                 | 230,67                         |
...
| Прогрузка отзывов (по 9)                           | 2472,08  | 7416,25     |
